...
class Button () : 
    def __init__(self,containerScr,inactive_label,active_label,clicked_label,y,x,id,onClick=None,shift = 2,reset_click_on_deactivate = True,selected_attr = curses.A_STANDOUT):
        ...
        self.width = max(len(self.inactive_label),len(self.active_label),len(self.clicked_label)) + 4
        self.active = False 
        self.clicked = False
